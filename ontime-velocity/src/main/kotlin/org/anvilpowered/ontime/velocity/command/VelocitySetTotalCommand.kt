...
class VelocitySetTotalCommand : CommonSetTotalCommand<Player, Player, TextComponent, CommandSource>(), Command {
    override fun execute(source: CommandSource, context: Array<String>) =
        super<CommonSetTotalCommand>.execute(source, context)

    override fun suggest(source: CommandSource, context: Array<String>): List<String> =
        super<CommonSetTotalCommand>.suggest(source, context)
}
