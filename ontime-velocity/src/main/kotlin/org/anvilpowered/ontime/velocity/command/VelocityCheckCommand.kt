...
class VelocityCheckCommand : CommonCheckCommand<Player, Player, TextComponent, CommandSource>(Player::class.java), Command {
    override fun execute(source: CommandSource, context: Array<String>) =
        super<CommonCheckCommand>.execute(source, context)

    override fun suggest(source: CommandSource, context: Array<String>): List<String> =
        super<CommonCheckCommand>.suggest(source, context)
}
