...
class SpongeSetTotalCommand : CommonSetTotalCommand<User, Player, Text, CommandSource>(), CommandCallable {

    companion object {
        val DESCRIPTION: Optional<Text> = Optional.of(Text.of(CommonOnTimeCommandNode.SET_TOTAL_DESCRIPTION))
