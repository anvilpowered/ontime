...
class SpongeCheckCommand : CommonCheckCommand<User, Player, Text, CommandSource>(Player::class.java), CommandCallable {

    companion object {
        val DESCRIPTION: Optional<Text> = Optional.of(Text.of(CommonOnTimeCommandNode.CHECK_DESCRIPTION))
